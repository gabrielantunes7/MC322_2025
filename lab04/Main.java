...
public class Main {
    public static void main(String[] args) throws Exception {
        ...
        SensorMovimentoCavalo sensorMovimentoL = new SensorMovimentoCavalo(5.0, roboCavalo); 
        roboCavalo.adicionarSensor(sensorMovimentoL);
        
        BispoRobo roboBispo = new BispoRobo("Bispo", "Leste", 3, 3, 3, 5, ambiente, TipoMaterial.NAO_METALICO);
        ambiente.adicionarRobo(roboBispo);
        SensorAlcanceDiagonal sensorDiagonal = new SensorAlcanceDiagonal(10.0, roboBispo, 5);
        roboBispo.adicionarSensor(sensorDiagonal);
