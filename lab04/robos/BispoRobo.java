...
// Classe BispoRobo (herdada de RoboTerrestre)
// Representa um robô que se move na diagonal, como um bispo no xadrez
// O BispoRobo tem um alcance máximo diagonal e pode se mover apenas dentro desse alcance
public class BispoRobo extends RoboTerrestre {
    ...
    public String getDescricao() {
        return "BispoRobo: " + nomeRobo + ", Direção: " + direcao + ", Posição: (" + xPosicao + ", " + yPosicao + "), " + "Alcance Máximo Diagonal: " + alcanceMaximoDiagonal;
    }

    @Override
    public char getRepresentacao() {
        return 'B'; // Representação do BispoRobo
    }
}
