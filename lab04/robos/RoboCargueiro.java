...
public class RoboCargueiro extends RoboAereo {
    ...
    public void levarCarga(int peso_carga, int delta_x, int delta_y) throws Exception {
    ...
    public String getDescricao() {
        return "RoboCargueiro: " + nomeRobo + ", Direção: " + direcao + ", Posição: (" + xPosicao + ", " + yPosicao
                + ", " + this.getZ() + "), Capacidade de Carga: " + capacidade_carga;
    }

    @Override
    public char getRepresentacao() {
        return 'C'; // Representação do RoboCargueiro
    }
}