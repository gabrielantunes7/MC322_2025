...
public class BispoRobo extends RoboTerrestre implements IBispoRobo {
    ...
    @Override
    public int getAlcanceMaximoDiagonal() {
        return this.alcanceMaximoDiagonal;
    }
